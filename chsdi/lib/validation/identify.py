...
class IdentifyServiceValidation(BaseFeaturesValidation):
    ...
    def __init__(self, request, service=None):
        ...
        self.esriGeometryTypes = (
            ...
            u'esriGeometryPointJSON',
            u'esriGeometryPolylineJSON',
            u'esriGeometryPolygonJSON',
            u'esriGeometryEnvelopeJSON'
        )
        ...
        if value is None and self._where is not None:
            ...
            try:
                if self._geometryType == 'esriGeometryEnvelope':
                    ...
                    print(conform_json)
                    print("HERE")
                    print(conform_json['geometry']['xmin'])
                    print("THERE")
                    minmaxvalues = str(conform_json['geometry']['xmin']) + "," + str(conform_json['geometry']['ymin']) + "," + str(conform_json['geometry']['xmax']) + "," + str(conform_json['geometry']['ymax'])
                    print(minmaxvalues)
